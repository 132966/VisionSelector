...
MODEL_NAME = 'VisionSelector-Qwen2.5-VL-3B-train-LayerMid-Attn-3epoch'
...
# 数据行
row = 2
cell = ws.cell(row=row, column=1, value='LayerMid-Attn-3epoch')
cell.font = header_font
cell.alignment = center_align
cell.border = thin_border
